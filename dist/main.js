...
/***/ "./node_modules/node-temperature-converter/index.js":
/*!**********************************************************!*\
  !*** ./node_modules/node-temperature-converter/index.js ***!
  \**********************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = {\r\n    Celsius: __webpack_require__(/*! ./src/Celsius */ \"./node_modules/node-temperature-converter/src/Celsius.js\"),\r\n    Fahrenheit: __webpack_require__(/*! ./src/Fahrenheit */ \"./node_modules/node-temperature-converter/src/Fahrenheit.js\"),\r\n    Kelvin: __webpack_require__(/*! ./src/Kelvin */ \"./node_modules/node-temperature-converter/src/Kelvin.js\")\r\n};\n\n//# sourceURL=webpack://weather_app/./node_modules/node-temperature-converter/index.js?");

/***/ }),

/***/ "./node_modules/node-temperature-converter/src/Celsius.js":
/*!****************************************************************!*\
  !*** ./node_modules/node-temperature-converter/src/Celsius.js ***!
  \****************************************************************/
/***/ ((module) => {

eval("class Celsius {\r\n    /**\r\n     * Celsius constructor\r\n     * @param x Degrees\r\n     */\r\n    constructor(x) {\r\n        if (!x && x !== 0 || typeof x !== \"number\") throw new Error(`Expected input to be a number, received ${typeof x}!`);\r\n        this.degrees = x;\r\n    }\r\n\r\n    /**\r\n     * Converts celsius to fahrenheit\r\n     */\r\n    toFahrenheit() {\r\n        const fm = this.degrees ? (this.degrees * 9 / 5) + 32 : 0;\r\n        return fm;\r\n    }\r\n\r\n    /**\r\n     * Converts celsius to kelvin\r\n     */\r\n    toKelvin() {\r\n        const fm = this.degrees ? this.degrees + 273.15 : 0;\r\n        return fm;\r\n    }\r\n\r\n    /**\r\n     * String representation of celsius\r\n     */\r\n    toString() {\r\n        return `${String(this.degrees || 0)}°C`;\r\n    }\r\n\r\n}\r\n\r\nmodule.exports = Celsius;\n\n//# sourceURL=webpack://weather_app/./node_modules/node-temperature-converter/src/Celsius.js?");

/***/ }),

/***/ "./node_modules/node-temperature-converter/src/Fahrenheit.js":
/*!*******************************************************************!*\
  !*** ./node_modules/node-temperature-converter/src/Fahrenheit.js ***!
  \*******************************************************************/
/***/ ((module) => {

eval("class Fahrenheit {\r\n    /**\r\n     * Fahrenheit constructor\r\n     * @param x Degrees\r\n     */\r\n    constructor(x) {\r\n        if (!x && x !== 0 || typeof x !== \"number\") throw new Error(`Expected input to be a number, received ${typeof x}!`);\r\n        this.degrees = x;\r\n    }\r\n\r\n    /**\r\n     * Converts Fahrenheit to celsius\r\n     */\r\n    toCelsius() {\r\n        const fm = this.degrees ? (this.degrees - 32) * 5 / 9 : 0;\r\n        return fm;\r\n    }\r\n\r\n    /**\r\n     * Converts Fahrenheit to kelvin\r\n     */\r\n    toKelvin() {\r\n        const fm = this.degrees ? (this.degrees - 32) * 5 / 9 + 273.15 : 0;\r\n        return fm;\r\n    }\r\n\r\n    /**\r\n     * String representation of Fahrenheit\r\n     */\r\n    toString() {\r\n        return `${String(this.degrees || 0)}°F`;\r\n    }\r\n\r\n}\r\n\r\nmodule.exports = Fahrenheit;\n\n//# sourceURL=webpack://weather_app/./node_modules/node-temperature-converter/src/Fahrenheit.js?");

/***/ }),

/***/ "./node_modules/node-temperature-converter/src/Kelvin.js":
/*!***************************************************************!*\
  !*** ./node_modules/node-temperature-converter/src/Kelvin.js ***!
  \***************************************************************/
/***/ ((module) => {

eval("class Kelvin {\r\n    /**\r\n     * Kelvin constructor\r\n     * @param x Degrees\r\n     */\r\n    constructor(x) {\r\n        if (!x && x !== 0 || typeof x !== \"number\") throw new Error(`Expected input to be a number, received ${typeof x}!`);\r\n        this.degrees = x;\r\n    }\r\n\r\n    /**\r\n     * Converts Kelvin to celsius\r\n     */\r\n    toCelsius() {\r\n        const fm = this.degrees ? this.degrees - 273.15 : 0;\r\n        return fm;\r\n    }\r\n\r\n    /**\r\n     * Converts Kelvin to Fahrenheit\r\n     */\r\n    toFahrenheit() {\r\n        const fm = this.degrees ? (this.degrees - 273.15) * 9 / 5 + 32 : 0;\r\n        return fm;\r\n    }\r\n\r\n    /**\r\n     * String representation of Kelvin\r\n     */\r\n    toString() {\r\n        return `${String(this.degrees || 0)}K`;\r\n    }\r\n\r\n}\r\n\r\nmodule.exports = Kelvin;\n\n//# sourceURL=webpack://weather_app/./node_modules/node-temperature-converter/src/Kelvin.js?");
